...
$packageRepo = 'http://ip_address:8081/service/local/nuget/chocorepotest'
...
$repoUsername = 'username'    # this must be empty is NOT using authentication
$repoPassword = 'password'    # this must be empty if NOT using authentication
